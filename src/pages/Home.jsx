  ...
  return (
    <div className="home ">
      <header className="h-20 flex justify-center header absolute top-0 left-0 w-full bg-white z-50">
        <div className="bg-white logo w-80 flex-none flex items-center pl-10 bg-white border-r">
          <svg
        ...
        <div className="mx-auto pt-4 pr-10 pl-10 pb-4 flex justify-between items-center w-full border-b">
